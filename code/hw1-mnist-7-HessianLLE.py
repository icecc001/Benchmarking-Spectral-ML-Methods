...
hessian_lle = LocallyLinearEmbedding(n_components=30, method='hessian')
...
# Parameters to tune
param_grid = {
    'hessian_lle__n_neighbors': [500, 600, 700],         # Tuning the number of neighbors
}
...
hessian_lle = LocallyLinearEmbedding(n_components = 30, method='hessian', n_neighbors = grid_search.best_params_['hessian_lle__n_neighbors'])
...
## plots
plot_2d(x_hessian_lle, sampled_y_encoded, filename = f'hw1/plots_{nsample}/Hessian_LLE_mnist_firsttwo.png', title="Hessian LLE - First Two Components - MNIST Data")
