...
hessian_lle = LocallyLinearEmbedding(n_components=10, method='hessian')
...
# Parameters to tune
param_grid = {
    'hessian_lle__n_neighbors': [70, 100, 150],         # Tuning the number of neighbors
}
...
hessian_lle = LocallyLinearEmbedding(n_components = 10, method='hessian', n_neighbors = grid_search.best_params_['hessian_lle__n_neighbors'])

# Apply hessian_lle
scaler = StandardScaler()
sampled_x_scaled = scaler.fit_transform(sampled_x)
x_hessian_lle = hessian_lle.fit_transform(sampled_x_scaled)
...
## plots
plot_2d(x_hessian_lle, sampled_y_encoded, filename = f'hw1/plots_{nsample}/Hessian_LLE_mnist_firsttwo_com10.png', title="Hessian LLE - First Two Components - MNIST Data")
